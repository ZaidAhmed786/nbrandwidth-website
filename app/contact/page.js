                ...
                <div>
                    <section className="contact-section fix section-padding">
                        <div className="container">
                            ...
                            <div className=" fw-bold text-center  py-3" style={{color: "#06a3da"}} >CONTACT US</div>
                                <h2 className="wow fadeInUp text-center" data-wow-delay=".3s" width>
                                If You Have Any Query, Feel Free To Contact Us
                                </h2>
                            </div>
                            <div className="contact-wrapper-2 pt-5">
